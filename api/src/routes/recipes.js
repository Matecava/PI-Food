...
const getAllRecipesApi = async()=>{
    const resu = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=634431ae1e86424a873863124f0051f3&addRecipeInformation=true&number=100`);
